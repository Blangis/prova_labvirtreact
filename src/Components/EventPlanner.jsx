    ...
    return (
        <div className="event-planner-container">
            ...
            <section className="testimonials">
                ...
                <div className="testimonial">
                    <p>"The concert I assisted it was very nice, and the attention to everyone was perfect"</p>
                    <p className="author">- Mariana Sanchez</p>
                </div>
                <div className="testimonial">
            ...
            <section className="contact">
                ...
                <form>
                    ...
                    <input type="email"placeholder="algo@correo.com"/>
